...
function CustomAdLayer({ width, height, child, setCanShowAverage, navigation }) {
  ...
  function getAdUnitID() {
    return __DEV__ ? TestIds.REWARDED : Platform.select({
      ios: 'ca-app-pub-5759305174337781/2219628639', // Reward iOS
      android: 'ca-app-pub-5759305174337781/6490106200', // Reward Android
    })
  }
  function getNewAd() {
    return RewardedAd.createForAdRequest(getAdUnitID(), {
